...
class Footer {
    constructor(author, prePath) {
        ...
        this._created = '2025-05-28T10:42:19+0900'
    ...
    #project() { return a(this.#externalLinkAttr(({href:`https://github.com/${this._author}/Random/`})), img({class:'icon', src:`${this._prePath}asset/image/logo/github/black.svg`})) }
