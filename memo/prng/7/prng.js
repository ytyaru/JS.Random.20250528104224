...
class Random {// Number(整数/小数(0≦r<1)), Booleanを返す
    constructor(prng, range) {
        this._prng = prng;
        this._range = range;
...
//    get i() {return this._range.fromIndex(Math.floor(this.r * this._range.l))}
//    get i() {return this._range.m + Math.floor(this.r * this._range.l)}
//    get i() {return Math.floor(this.r * this._range.l) + this._range.m}
//    get i() {return this.r * (this._range.M+1) + this._range.m}//0<m/Mの時のみ。負数だとバグる
//    get i() {// prngが生成する最大値や最小値を越えた値を期待されたら？
//        return this.r * (this._range.M+1) + this._range.m
//        return this._prng.r
//    }
