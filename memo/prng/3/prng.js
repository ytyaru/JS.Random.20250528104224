...
//        const R = rs.reduce((s,v,i)=>s+v,0);
//        return 1<=R ? rs[0] : R;
        /*
        const r = this.ns.reduce((s,v,i)=>{
            let V = v;
            [...new Array(i+1)].map(_=>V/=0x100000000);
            console.log(`get r() [${i}]:${V} ${s+V}`)
            return s+V
        },0);
        */
        /*
        return this.ns.reduce((s,v,i)=>{
            let V = v;
            [...new Array(i+1)].map(_=>V/=0x100000000);
            console.log(`get r() [${i}]:${V} ${s+V}`)
            return s+V
        ...
        */
        ...
        for (let n=0; n<ns.length; n++) {
            let N = ns[n];
            [...new Array(n+1)].map(_=>N=N/0x100000000);
