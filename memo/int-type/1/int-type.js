...
//        return u < this._halfLen ? u : (this.min+(this._halfLen - u));
//        return u < this._halfLen ? u : (this.min+(this._isB ? (this._halfLen - u) : (this._halfLen - u)));
//        return u < this._halfLen ? u : (this.min+(this._isB ? (u*-1n) : (u*-1)));
